...
import com.im_bmob.view.HeaderLayout.HeaderStyle;
import com.im_bmob.view.HeaderLayout.onLeftImageButtonClickListener;
import com.im_bmob.view.HeaderLayout.onRightImageButtonClickListener;
	...
	public void ShowToast(final int resId) {
		runOnUiThread(new Runnable() {
			...
			public void run() {
				// TODO Auto-generated method stub
				if (mToast == null) {
					mToast = Toast.makeText(BaseActivity3.this.getApplicationContext(), resId,
							Toast.LENGTH_LONG);
				} else {
	...
	public void showOfflineDialog(final Context context) {
		...
		dialog.SetOnSuccessListener(new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialogInterface, int userId) {
				...
				startActivity(new Intent(context, LoginActivity3.class));
				finish();
