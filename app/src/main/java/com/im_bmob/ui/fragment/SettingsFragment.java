...
import com.im_bmob.ui.BlackListActivity;
import com.im_bmob.ui.FragmentBase;
import com.im_bmob.ui.LoginActivity3;
import com.im_bmob.ui.SetMyInfoActivity;
import com.im_bmob.util.SharePreferenceUtil;
...
public class SettingsFragment extends FragmentBase implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.btn_logout:
			...
			getActivity().finish();
			startActivity(new Intent(getActivity(), LoginActivity3.class));
			break;
