...
/**
 * 登陆
 * @ClassName: MainActivity3
 * @Description: TODO
 * @author smile
 * @date 2014-5-29 下午2:45:35
 */
public class MainActivity3 extends ActivityBase implements EventListener {
	...
	private void refreshNewMsg(BmobMsg message){
		...
		//也要存储起来
		if(message!=null){
			BmobChatManager.getInstance(MainActivity3.this).saveReceiveMessage(true,message);
		}
